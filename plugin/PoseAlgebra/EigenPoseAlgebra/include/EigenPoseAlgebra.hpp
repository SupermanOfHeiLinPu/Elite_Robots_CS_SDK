#ifndef __ELITE__EIGEN_POSE_ALGEBRA_HPP__
#define __ELITE__EIGEN_POSE_ALGEBRA_HPP__
...
class EigenPoseAlgebra : public PoseAlgebraBase {
   public:
    EigenPoseAlgebra() = default;
    ~EigenPoseAlgebra() override = default;
...
#endif  // __ELITE__EIGEN_POSE_ALGEBRA_HPP__
